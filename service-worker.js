...
const CACHE_NAME = 'halal-report-v1.1.1';
const CORE_ASSETS = [
...
self.addEventListener('fetch', (event) => {
  ...
  // Only handle requests to our own origin. Cross-origin requests (Firestore's
  // long-polling/streaming channel, Firebase Storage, fonts, etc.) must pass
  // straight through untouched - wrapping them here breaks the streaming
  // connection ("FetchEvent ... resulted in a network error response" /
  // "transport errored") and made the shop/inventory data never arrive.
